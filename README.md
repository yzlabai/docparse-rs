...
**差异化记分牌**(实测,2026-06-10):单二进制 **19.1MB**(含纯 Rust OCR 推理栈)、运行时依赖 **0**、解析延迟 **<10ms**、**700 页/s**、同输入跨 CLI/MCP/REST **逐字节一致**、chunk 引用可定位率 **100%**。综合测评(含与 ODL/Docling 的逐轴对比)见 [docs/testresults/2026-06-10-benchmark-roundup.md](docs/testresults/2026-06-10-benchmark-roundup.md)。
