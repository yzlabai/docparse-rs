...
**剩余 Gate 2(打磨,非阻断)**:① 后处理阈值——v6 yml `DBPostProcess thresh 0.2 / box_thresh 0.4 / unclip 1.4` vs 现役 `0.3 / 1.6`,可 A/B 调列表空格;② `DET_SIDE` 640 vs 960 召回 A/B;③ medium 档质量/速度量化;④ 更多扫描样例回归。
