...
> 日期：2026-06-10（TEDS 内容配对+2D过滤纠偏） · 来源：`scripts/eval/compare_docling.py` · 数据：Docling 自带 born-digital 测试集（tmp/refer/docling/tests/data，其 groundtruth = Docling 自身输出）
