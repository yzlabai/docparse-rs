...
| 文档 | NID | TEDS | MHS | 备注 |
|---|---|---|---|---|
| 2203.01017v2 | 0.905 | 0.213 | 0.652 | 表格 我方7/Docling6 |
| 2206.01062 | 0.740 | 0.243 | 0.500 | 表格 我方9/Docling5 |
| 2305.03393v1-pg9 | 0.871 | 0.060 | 1.000 | 表格 我方1/Docling1 |
| 2305.03393v1 | 0.865 | 0.062 | 0.706 | 表格 我方2/Docling2 |
...
| right_to_left_02 | 0.040 | 1.000 | 1.000 | RTL（我方 LTR，超范围） |
...
| 切片 | 文档数 | NID | TEDS | MHS |
|---|---|---|---|---|
| **born-digital LTR**（去 RTL）| 10 | **0.818** | — | **0.634** |
| 含表格子集（TEDS 仅在有表文档有意义）| 6 | — | **0.157** | — |
| RTL（超范围，仅记录）| 3 | 0.029 | — | — |
