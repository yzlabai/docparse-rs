...
| 文档 | NID | TEDS | MHS | 备注 |
|---|---|---|---|---|
| 2203.01017v2 | 0.420 | 0.000 | 0.080 | 表格 我方0/Docling6 |
| 2206.01062 | 0.341 | 0.000 | 0.000 | 表格 我方0/Docling5 |
...
| 切片 | 文档数 | NID | TEDS | MHS |
|---|---|---|---|---|
| **born-digital LTR**（去 RTL）| 10 | **0.600** | — | **0.257** |
| 含表格子集（TEDS 仅在有表文档有意义）| 6 | — | **0.006** | — |
| RTL（超范围，仅记录）| 3 | 0.006 | — | — |

- **表格检出召回**（Docling 有表的 LTR 文档中我方也检出 ≥1 表）：1/6。我方 M4 只做**有框**表格，学术论文多为**无框**（booktabs）→ 多数 TEDS=0，已知限制（→ N4 无框表格）。
- 解析：13/13 成功，0 panic。
